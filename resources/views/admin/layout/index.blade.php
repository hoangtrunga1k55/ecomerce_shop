...
<head>
    ...
    <link rel="stylesheet" href="plugins/tempusdominus-bootstrap-4/css/a.css">
    <!-- iCheck -->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image" id="user">
                    <img src="dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                    <a href="admin/index" class="d-block">Alexander Pierce</a>
                </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="admin/feature/list" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>List Product</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="admin/feature/add" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Add Feature Products</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="admin/latest/list" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>List Latest Product</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="admin/latest/add" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="admin/offer/list" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>List Offer</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="admin/offer/add" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Add Offer</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="admin/testimonial/list" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>List Testimonial</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="admin/testimonial/add" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Add Testimonial</p>
                                </a>
                            </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="admin/manage/list" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>List Quanity of product with size</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="admin/manage/add" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Add Quanity of product with size</p>
                                </a>
                            </li>
                        </ul>
                    </li>
