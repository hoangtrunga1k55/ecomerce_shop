            ...
            <table id="laravel_crud" class="table table-striped table-bordered">
                ...
                @foreach($posts as $post)
                    <tr id="row_{{$post->id}}">
                        ...
                        <td>
                            <a href="javascript:void(0)" data-id="{{ $post->id }}" class="btn btn-danger" onclick="devarePost(event.target)">Devare</a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
